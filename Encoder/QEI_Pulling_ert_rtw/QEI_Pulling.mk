...
## Generated on : Thu Oct 31 07:14:25 2024
...
COMPILER_COMMAND_FILE     = QEI_Pulling_comp.rsp
CMD_FILE                  = QEI_Pulling.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/QEI_Pulling.elf
...
%.o : $(START_DIR)/QEI_Pulling_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/QEI_Pulling_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/QEI_Pulling_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/QEI_Pulling_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/QEI_Pulling_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
QEI_Pulling.o : $(START_DIR)/QEI_Pulling_ert_rtw/QEI_Pulling.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/QEI_Pulling_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
